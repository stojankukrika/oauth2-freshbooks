...
namespace Stojankukrika\OAuth2\Client\Provider\Test;

use League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use League\OAuth2\Client\Tool\QueryBuilderTrait;
use PHPUnit\Framework\TestCase;
use Stojankukrika\OAuth2\Client\Provider\FreshBooks;
use Mockery as m;
use Stojankukrika\OAuth2\Client\Provider\FreshBooksOwner;
...
JSON;
    ...
    /**
     * @expectedException \Stojankukrika\OAuth2\Client\Provider\Exception\IdentityProviderException
